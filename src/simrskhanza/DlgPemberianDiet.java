...
public class DlgPemberianDiet extends javax.swing.JDialog {
    ...
    public DlgPemberianDiet(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Object[] row={"No.Rawat","Nama Pasien","Kamar","Tanggal","Waktu","Jam","Diet","Diagnosa","Jm Pembuatan","Jm Exp."};
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-10-2021" }));
        ...
        cmbJam1.setBounds(840, 10, 72, 23);
        ...
        cmbMnt1.setBounds(920, 10, 72, 23);

        jLabel13.setText("Jam Pembuatan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(740, 10, 100, 23);
        ...
        cmbJam2.setBounds(840, 40, 72, 23);
        ...
        cmbMnt2.setBounds(920, 40, 72, 23);

        jLabel14.setText("Jam Exp :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(740, 40, 100, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            Sequel.menyimpan("detail_beri_diet","'"+TNoRw.getText()+"','"+Kamar.getText()+"','"+
                    ...
                    cmbJam2.getSelectedItem()+':'+cmbMnt2.getSelectedItem()+"'","data");
            tampil();
            emptTeks();
        }
  ...
  isForm();                
    ...
    private void MnLabelDietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLabelDietActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            param.put("emailrs",akses.getemailrs());
            param.put("logo",Sequel.cariGambar("select logo from setting"));
            Valid.MyReportqry("rptLabelDiet.jasper","report","::[ Label Diet Satuan]::",
    ...
    private void MnLabelDiet1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLabelDiet1ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            param.put("emailrs",akses.getemailrs());
            param.put("logo",Sequel.cariGambar("select logo from setting"));
            Valid.MyReportqry("rptLabelDiet.jasper","report","::[ Label Diet Banyak ]::",
                "select detail_beri_diet.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir, " +
                "concat(detail_beri_diet.kd_kamar,', ',bangsal.nm_bangsal) as kamar,detail_beri_diet.tanggal,detail_beri_diet.waktu,jam_diet_pasien.jam,diet.nama_diet,detail_beri_diet.jam_awal_diet,detail_beri_diet.jam_akhir_diet " +
                "from detail_beri_diet inner join reg_periksa inner join pasien inner join diet inner join kamar inner join bangsal inner join jam_diet_pasien " +
                "on detail_beri_diet.no_rawat=reg_periksa.no_rawat " +
    ...
    public void tampil() {     
        try{
            ...
            ps=koneksi.prepareStatement("select detail_beri_diet.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, " +
                "concat(detail_beri_diet.kd_kamar,', ',bangsal.nm_bangsal),detail_beri_diet.tanggal,detail_beri_diet.waktu,jam_diet_pasien.jam,diet.nama_diet,detail_beri_diet.jam_awal_diet,detail_beri_diet.jam_akhir_diet " +
                "from detail_beri_diet inner join reg_periksa inner join pasien inner join diet inner join kamar inner join bangsal inner join jam_diet_pasien " +
                "on detail_beri_diet.no_rawat=reg_periksa.no_rawat " +
                "and detail_beri_diet.kd_kamar=kamar.kd_kamar "+
                "and kamar.kd_bangsal=bangsal.kd_bangsal "+
