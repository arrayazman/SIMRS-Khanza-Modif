...
public final class DlgAuditKepatuhanAPD extends javax.swing.JDialog {
    ...
    private double topiY=0,maskerY=0,kacamataY=0,sarungtanganY=0,apronY=0,sepatuY=0,ttltopiY=0,ttlmaskerY=0,ttlkacamataY=0,ttlsarungtanganY=0,ttlapronY=0,ttlsepatuY=0,ttlpenilaianY=0;    
    private double topiX=0,maskerX=0,kacamataX=0,sarungtanganX=0,apronX=0,sepatuX=0,ttltopiX=0,ttlmaskerX=0,ttlkacamataX=0,ttlsarungtanganX=0,ttlapronX=0,ttlsepatuX=0,ttlpenilaianX=0;
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nip.getText().trim().equals("")||NamaPetugas.getText().trim().equals("")){
            ...
            String Ntopi,Nmasker,Nkacamata,Nsarungtangan,Napron,Nsepatu;
 if(Topi.getSelectedItem().toString()=="Tidak"){
               Ntopi = "0";
            }else {
               Ntopi = "1";
            }

if(Masker.getSelectedItem().toString()=="Tidak"){
                Nmasker = "0";
            }else {
                Nmasker = "1";
            }

if(KacaMata.getSelectedItem().toString()=="Tidak"){
               Nkacamata = "0";
            }else {
                Nkacamata = "1";
            }

if(SarungTangan.getSelectedItem().toString()=="Tidak"){
                Nsarungtangan = "0";
            }else {
                Nsarungtangan = "1";
            }

if(Apron.getSelectedItem().toString()=="Tidak"){
                Napron = "0";
            }else {
               Napron = "1";
            }

if(Sepatu.getSelectedItem().toString()=="Tidak"){
                Nsepatu = "0";
            }else {
               Nsepatu = "1";
            }

            if(Sequel.menyimpantf("audit_kepatuhan_apd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",15,new String[]{
                ...
                Ntopi,Nmasker,Nkacamata,Nsarungtangan,Napron,Nsepatu 
...
if(Sepatu.getSelectedItem().toString()=="Tidak"){
            ...
            Sequel.mengedit("audit_kepatuhan_apd","nik=? and tindakan=? and tanggal=?","nik=?,tindakan=?,tanggal=?,topi=?,masker=?,kacamata=?,sarungtangan=?,apron=?,sepatu=?,nilai_topi=?,nilai_masker=?,nilai_kacamata=?,nilai_sarungtangan=?,nilai_apron=?,nilai_sepatu=?",18,new String[]{
                ...
                SarungTangan.getSelectedItem().toString(),Apron.getSelectedItem().toString(),Sepatu.getSelectedItem().toString(), Ntopi,Nmasker,Nkacamata,Nsarungtangan,Napron,Nsepatu,tbObat.getValueAt(tbObat.getSelectedRow(),2).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),1).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            });
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptAuditKepatuhanAPD.jasper","report","::[ Data Audit Kepatuhan APD ]::",
                    ...
                    "audit_kepatuhan_apd.masker,audit_kepatuhan_apd.kacamata,audit_kepatuhan_apd.sarungtangan,audit_kepatuhan_apd.apron,audit_kepatuhan_apd.sepatu,"+ 
                     "audit_kepatuhan_apd.nilai_topi,audit_kepatuhan_apd.nilai_masker,audit_kepatuhan_apd.nilai_kacamata,audit_kepatuhan_apd.nilai_sarungtangan,audit_kepatuhan_apd.nilai_apron,audit_kepatuhan_apd.nilai_sepatu "+
    ...
    private void tampil() {
        ...
        try{
            ...
            try {
                ...
                ttltopiX=0;ttlmaskerX=0;ttlkacamataX=0;ttlsarungtanganX=0;ttlapronX=0;ttlsepatuX=0;ttlpenilaianX=0;
                ttltopiY=0;ttlmaskerY=0;ttlkacamataY=0;ttlsarungtanganY=0;ttlapronY=0;ttlsepatuY=0;ttlpenilaianY=0;
                i=1;
                while(rs.next()){
                    
//                    

                    topiY=Double.parseDouble(rs.getString("topi").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttltopiY=ttltopiY+topiY;
                    maskerY=Double.parseDouble(rs.getString("masker").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttlmaskerY=ttlmaskerY+maskerY;
                    kacamataY=Double.parseDouble(rs.getString("kacamata").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttlkacamataY=ttlkacamataY+kacamataY;
                    sarungtanganY=Double.parseDouble(rs.getString("sarungtangan").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttlsarungtanganY=ttlsarungtanganY+sarungtanganY;
                    apronY=Double.parseDouble(rs.getString("apron").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttlapronY=ttlapronY+apronY;
                    sepatuY=Double.parseDouble(rs.getString("sepatu").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttlsepatuY=ttlsepatuY+sepatuY;
                    ttlpenilaianY=ttlpenilaianY+(((ttltopiY+ttlmaskerY+ttlkacamataY+ttlsarungtanganY+ttlapronY+ttlsepatuY+ttlpenilaianY)/6)*100);
                   
                    topiX=Double.parseDouble(rs.getString("topi").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttltopiX=ttltopiX+topiX;
                    maskerX=Double.parseDouble(rs.getString("masker").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttlmaskerX=ttlmaskerX+maskerX;
                    kacamataX=Double.parseDouble(rs.getString("kacamata").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttlkacamataX=ttlkacamataX+kacamataX;
                    sarungtanganX=Double.parseDouble(rs.getString("sarungtangan").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttlsarungtanganX=ttlsarungtanganX+sarungtanganX;
                    apronX=Double.parseDouble(rs.getString("apron").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttlapronX=ttlapronX+apronX;
                    sepatuX=Double.parseDouble(rs.getString("sepatu").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttlsepatuX=ttlsepatuX+sepatuX;                  
                    ttlpenilaianY=ttlpenilaianX+(((ttltopiX+ttlmaskerX+ttlkacamataX+ttlsarungtanganX+ttlapronX+ttlsepatuX+ttlpenilaianY)/6)*100);

                    
                   topi=rs.getDouble("nilai_topi");
                    ttltopi=ttltopi+topi;
                    masker=rs.getDouble("nilai_masker");
                    ttlmasker=ttlmasker+masker;
                    kacamata=rs.getDouble("nilai_kacamata");
                    ttlkacamata=ttlkacamata+kacamata;
                    sarungtangan=rs.getDouble("nilai_sarungtangan");
                    ttlsarungtangan=ttlsarungtangan+sarungtangan;
                    apron=rs.getDouble("nilai_apron");
                    ttlapron=ttlapron+apron;
                    sepatu=rs.getDouble("nilai_sepatu");
                ...
                i=i-1;
                if(i>0){ tabMode.addRow(new String[]{
                        "","Tidak Dilakukan Tindakan",":","","",""+ttltopiX,""+ttlmaskerX,""+ttlkacamataX,""+ttlsarungtanganX,""+ttlapronX,""+ttlsepatuX,
                        ""+(ttltopiX+ttlmaskerX+ttlkacamataX+ttlsarungtanganX+ttlapronX+ttlsepatuX)
                    });
                
                    tabMode.addRow(new String[]{
                        "","Ya",":","","",""+ttltopiY,""+ttlmaskerY,""+ttlkacamataY,""+ttlsarungtanganY,""+ttlapron,""+ttlsepatuY,
                        ""+(ttltopiY+ttlmaskerY+ttlkacamataY+ttlsarungtanganY+ttlapronY+ttlsepatuY)
                    });
                    tabMode.addRow(new String[]{
