...
public final class DlgAuditCuciTanganMedis extends javax.swing.JDialog {
    ...
    private double sebelum_menyentuh_pasienY=0,sebelum_tehnik_aseptikY=0,setelah_terpapar_cairan_tubuh_pasienY=0,
                setelah_kontak_dengan_pasienY=0,setelah_kontak_dengan_lingkungan_pasienY=0,ttlsebelum_menyentuh_pasienY=0,
                ttlsebelum_tehnik_aseptikY=0,ttlsetelah_terpapar_cairan_tubuh_pasienY=0,ttlsetelah_kontak_dengan_pasienY=0,
                ttlsetelah_kontak_dengan_lingkungan_pasienY=0,ttlpenilaianY=0;
    
    private double sebelum_menyentuh_pasienN=0,sebelum_tehnik_aseptikN=0,setelah_terpapar_cairan_tubuh_pasienN=0,
                setelah_kontak_dengan_pasienN=0,setelah_kontak_dengan_lingkungan_pasienN=0,ttlsebelum_menyentuh_pasienN=0,
                ttlsebelum_tehnik_aseptikN=0,ttlsetelah_terpapar_cairan_tubuh_pasienN=0,ttlsetelah_kontak_dengan_pasienN=0,
                ttlsetelah_kontak_dengan_lingkungan_pasienN=0,ttlpenilaianN=0;
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Nip.getText().trim().equals("")||NamaPetugas.getText().trim().equals("")){
            ...
            String NSebelumMenyentuh,NSebelumTehnik,NSetelahTerpapar,NSetelahKontak,NSetelahLingkungan;
 if(SebelumMenyentuh.getSelectedItem().toString()=="Tidak"){
               NSebelumMenyentuh = "0";
            }else {
               NSebelumMenyentuh = "1";
            }

if(SebelumTehnik.getSelectedItem().toString()=="Tidak"){
                NSebelumTehnik = "0";
            }else {
                NSebelumTehnik = "1";
            }

if(SetelahTerpapar.getSelectedItem().toString()=="Tidak"){
                NSetelahTerpapar = "0";
            }else {
                NSetelahTerpapar = "1";
            }

if(SetelahKontak.getSelectedItem().toString()=="Tidak"){
                NSetelahKontak = "0";
            }else {
                NSetelahKontak = "1";
            }

if(SetelahLingkungan.getSelectedItem().toString()=="Tidak"){
                NSetelahLingkungan = "0";
            }else {
               NSetelahLingkungan = "1";
            }

            
            if(Sequel.menyimpantf("audit_cuci_tangan_medis","?,?,?,?,?,?,?,?,?,?,?,?","Data",12,new String[]{
                ...
                NSebelumMenyentuh,NSebelumTehnik,NSetelahTerpapar,NSetelahKontak,NSetelahLingkungan
            })==true){
                tampil();
                emptTeks();
            }  
...
if(SetelahLingkungan.getSelectedItem().toString()=="Tidak"){
            ...
            Sequel.mengedit("audit_cuci_tangan_medis","nik=? and tanggal=?","tanggal=?,nik=?,sebelum_menyentuh_pasien=?,sebelum_tehnik_aseptik=?,setelah_terpapar_cairan_tubuh_pasien=?,setelah_kontak_dengan_pasien=?,setelah_kontak_dengan_lingkungan_pasien=?,nilai_sebelum_menyentuh_pasien=?,nilai_sebelum_tehnik_aseptik=?,nilai_setelah_terpapar_cairan_tubuh_pasien=?,nilai_setelah_kontak_dengan_pasien=?,nilai_setelah_kontak_dengan_lingkungan_pasien=?",14,new String[]{
                ...
                SetelahKontak.getSelectedItem().toString(),SetelahLingkungan.getSelectedItem().toString(), NSebelumMenyentuh,NSebelumTehnik,NSetelahTerpapar,NSetelahKontak,NSetelahLingkungan,tbObat.getValueAt(tbObat.getSelectedRow(),1).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            });
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "audit_cuci_tangan_medis.sebelum_tehnik_aseptik,audit_cuci_tangan_medis.setelah_terpapar_cairan_tubuh_pasien,"+
                    "audit_cuci_tangan_medis.setelah_kontak_dengan_pasien,audit_cuci_tangan_medis.setelah_kontak_dengan_lingkungan_pasien, "+
                    "audit_cuci_tangan_medis.nilai_sebelum_menyentuh_pasien,audit_cuci_tangan_medis.nilai_sebelum_tehnik_aseptik,audit_cuci_tangan_medis.nilai_setelah_terpapar_cairan_tubuh_pasien, "+
                    "audit_cuci_tangan_medis.nilai_setelah_kontak_dengan_pasien,audit_cuci_tangan_medis.nilai_setelah_kontak_dengan_lingkungan_pasien "+          
            ...
            try {
                ...
                ttlsebelum_menyentuh_pasienN=0;ttlsebelum_tehnik_aseptikN=0;ttlsetelah_terpapar_cairan_tubuh_pasienN=0;ttlsetelah_kontak_dengan_pasienN=0;ttlsetelah_kontak_dengan_lingkungan_pasienN=0;ttlpenilaianN=0;
                ttlsebelum_menyentuh_pasienY=0;ttlsebelum_tehnik_aseptikY=0;ttlsetelah_terpapar_cairan_tubuh_pasienY=0;ttlsetelah_kontak_dengan_pasienY=0;ttlsetelah_kontak_dengan_lingkungan_pasienY=0;ttlpenilaianY=0;
                
                i=1;
                while(rs.next()){
                    
                    
                    sebelum_menyentuh_pasienY=Double.parseDouble(rs.getString("sebelum_menyentuh_pasien").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttlsebelum_menyentuh_pasienY=ttlsebelum_menyentuh_pasienY+sebelum_menyentuh_pasienY;
                    sebelum_tehnik_aseptikY=Double.parseDouble(rs.getString("sebelum_tehnik_aseptik").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttlsebelum_tehnik_aseptikY=ttlsebelum_tehnik_aseptikY+sebelum_tehnik_aseptikY;
                    setelah_terpapar_cairan_tubuh_pasienY=Double.parseDouble(rs.getString("setelah_terpapar_cairan_tubuh_pasien").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttlsetelah_terpapar_cairan_tubuh_pasienY=ttlsetelah_terpapar_cairan_tubuh_pasienY+setelah_terpapar_cairan_tubuh_pasienY;
                    setelah_kontak_dengan_pasienY=Double.parseDouble(rs.getString("setelah_kontak_dengan_pasien").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttlsetelah_kontak_dengan_pasienY=ttlsetelah_kontak_dengan_pasienY+setelah_kontak_dengan_pasienY;
                    setelah_kontak_dengan_lingkungan_pasienY=Double.parseDouble(rs.getString("setelah_kontak_dengan_lingkungan_pasien").replaceAll("Ya","1").replaceAll("Tidak","0").replaceAll("-","0"));
                    ttlsetelah_kontak_dengan_lingkungan_pasienY=ttlsetelah_kontak_dengan_lingkungan_pasienY+setelah_kontak_dengan_lingkungan_pasienY;
                    ttlpenilaianY=ttlpenilaianY+(((sebelum_menyentuh_pasienY+sebelum_tehnik_aseptikY+setelah_terpapar_cairan_tubuh_pasienY+setelah_kontak_dengan_pasienY+setelah_kontak_dengan_lingkungan_pasienY)/5)*100);
                   
                    sebelum_menyentuh_pasienN=Double.parseDouble(rs.getString("sebelum_menyentuh_pasien").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttlsebelum_menyentuh_pasienN=ttlsebelum_menyentuh_pasienN+sebelum_menyentuh_pasienN;
                    sebelum_tehnik_aseptikN=Double.parseDouble(rs.getString("sebelum_tehnik_aseptik").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttlsebelum_tehnik_aseptikN=ttlsebelum_tehnik_aseptikN+sebelum_tehnik_aseptikN;
                    setelah_terpapar_cairan_tubuh_pasienN=Double.parseDouble(rs.getString("setelah_terpapar_cairan_tubuh_pasien").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttlsetelah_terpapar_cairan_tubuh_pasienN=ttlsetelah_terpapar_cairan_tubuh_pasienN+setelah_terpapar_cairan_tubuh_pasienN;
                    setelah_kontak_dengan_pasienN=Double.parseDouble(rs.getString("setelah_kontak_dengan_pasien").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttlsetelah_kontak_dengan_pasienN=ttlsetelah_kontak_dengan_pasienN+setelah_kontak_dengan_pasienN;
                    setelah_kontak_dengan_lingkungan_pasienN=Double.parseDouble(rs.getString("setelah_kontak_dengan_lingkungan_pasien").replaceAll("Ya","0").replaceAll("Tidak","0").replaceAll("-","1"));
                    ttlsetelah_kontak_dengan_lingkungan_pasienN=ttlsetelah_kontak_dengan_lingkungan_pasienN+setelah_kontak_dengan_lingkungan_pasienN;
                    ttlpenilaianN=ttlpenilaianN+(((sebelum_menyentuh_pasienN+sebelum_tehnik_aseptikN+setelah_terpapar_cairan_tubuh_pasienN+setelah_kontak_dengan_pasienN+setelah_kontak_dengan_lingkungan_pasienN)/5)*100);
                   
                    
                    sebelum_menyentuh_pasien=rs.getDouble("nilai_sebelum_menyentuh_pasien");
                    ttlsebelum_menyentuh_pasien=ttlsebelum_menyentuh_pasien+sebelum_menyentuh_pasien;
                    sebelum_tehnik_aseptik=rs.getDouble("nilai_sebelum_tehnik_aseptik");
                    ttlsebelum_tehnik_aseptik=ttlsebelum_tehnik_aseptik+sebelum_tehnik_aseptik;
                    setelah_terpapar_cairan_tubuh_pasien=rs.getDouble("nilai_setelah_terpapar_cairan_tubuh_pasien");
                    ttlsetelah_terpapar_cairan_tubuh_pasien=ttlsetelah_terpapar_cairan_tubuh_pasien+setelah_terpapar_cairan_tubuh_pasien;
                    setelah_kontak_dengan_pasien=rs.getDouble("nilai_setelah_kontak_dengan_pasien");
                    ttlsetelah_kontak_dengan_pasien=ttlsetelah_kontak_dengan_pasien+setelah_kontak_dengan_pasien;
                    setelah_kontak_dengan_lingkungan_pasien=rs.getDouble("nilai_setelah_kontak_dengan_lingkungan_pasien");
                ...
                if(i>0){ 
                    tabMode.addRow(new String[]{
                        "","Tidak Dilakukan Tindakan",":",""+ttlsebelum_menyentuh_pasienN,""+ttlsebelum_tehnik_aseptikN,""+ttlsetelah_terpapar_cairan_tubuh_pasienN,
                        ""+ttlsetelah_kontak_dengan_pasienN,""+ttlsetelah_kontak_dengan_lingkungan_pasienN,""+(ttlsebelum_menyentuh_pasienN+ttlsebelum_tehnik_aseptikN+
                        ttlsetelah_terpapar_cairan_tubuh_pasienN+ttlsetelah_kontak_dengan_pasienN+ttlsetelah_kontak_dengan_lingkungan_pasienN)
                    });
                    tabMode.addRow(new String[]{
                        "","Ya",":",""+ttlsebelum_menyentuh_pasienY,""+ttlsebelum_tehnik_aseptikY,""+ttlsetelah_terpapar_cairan_tubuh_pasienY,
                        ""+ttlsetelah_kontak_dengan_pasienY,""+ttlsetelah_kontak_dengan_lingkungan_pasienY,""+(ttlsebelum_menyentuh_pasienY+ttlsebelum_tehnik_aseptikY+
                        ttlsetelah_terpapar_cairan_tubuh_pasienY+ttlsetelah_kontak_dengan_pasienY+ttlsetelah_kontak_dengan_lingkungan_pasienY)
                    });
                    tabMode.addRow(new String[]{
