...
//GEN-FIRST:event_BtnPrintActionPerformed
            ...
            case 3:
                if(tabModePemeriksaan.getRowCount()==0){
                    ...
                    Valid.MyReportqry("rptJalanPemeriksaan.jasper","report","::[ Data Pemeriksaan Rawat Jalan ]::",
                            "select pemeriksaan_ralan.no_rawat,reg_periksa.no_rkm_medis,poliklinik.nm_poli,pasien.nm_pasien,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y')as tgl_lahir,"+
                            ...
                            "pemeriksaan_ralan.rtl,pemeriksaan_ralan.penilaian,pemeriksaan_ralan.instruksi,pemeriksaan_ralan.evaluasi,pemeriksaan_ralan.nip,pegawai.nama,sha1(pegawai.nama) as sdkjari,pegawai.nama,pegawai.bidang "+
                            ...
                            "left join sidikjari on sidikjari.id=pegawai.id where "+        
