...
public final class SuratKeteranganRawatInap extends javax.swing.JDialog {
    ...
    public SuratKeteranganRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat","No.Rawat","No.R.M.","Nama Pasien","Dari Tanggal","Sampai Tanggal","Lama Sakit"
        }){
    ...
    private void initComponents() {
        ...
        MnCetakSuratCheckIN = new javax.swing.JMenuItem();
        MnCetakSuratCheckOUT = new javax.swing.JMenuItem();
        ...
        MnCetakSuratCheckIN.setBackground(new java.awt.Color(250, 250, 250));
        MnCetakSuratCheckIN.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratCheckIN.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratCheckIN.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/download24.png"))); // NOI18N
        MnCetakSuratCheckIN.setText("SKD Check IN");
        MnCetakSuratCheckIN.setName("MnCetakSuratCheckIN"); // NOI18N
        MnCetakSuratCheckIN.setPreferredSize(new java.awt.Dimension(250, 26));
        MnCetakSuratCheckIN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratCheckINActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnCetakSuratCheckIN);

        MnCetakSuratCheckOUT.setBackground(new java.awt.Color(250, 250, 250));
        MnCetakSuratCheckOUT.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakSuratCheckOUT.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakSuratCheckOUT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/upload24.png"))); // NOI18N
        MnCetakSuratCheckOUT.setText("SKD Check Out");
        MnCetakSuratCheckOUT.setName("MnCetakSuratCheckOUT"); // NOI18N
        MnCetakSuratCheckOUT.setPreferredSize(new java.awt.Dimension(250, 26));
        MnCetakSuratCheckOUT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakSuratCheckOUTActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnCetakSuratCheckOUT);
        ...
        MnCetakSuratRawat.getAccessibleContext().setAccessibleParent(null);
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-08-2023" }));
        ...
        jLabel16.setBounds(400, 40, 30, 23);

        TanggalAwal.setForeground(new java.awt.Color(50, 70, 50));
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-08-2023" }));
        ...
        LamaSakit.setBounds(620, 40, 106, 23);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_keterangan_rawat_inap","no_surat=?","no_surat=?,no_rawat=?,tanggalawal=?,tanggalakhir=?,lamasakit=?",6,new String[]{
       ...
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                Valid.MyReportqry("rptSuratKeteranganRawatInap.jasper","report","::[ Surat Keterangan Rawat Inap ]::",
                              ...
                              " pasien.tmp_lahir,pasien.no_rkm_medis,pasien.agama,kamar_inap.diagnosa_awal,kamar_inap.diagnosa_akhir,pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.pekerjaan,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat" +
                              " from reg_periksa inner join pasien inner join dokter inner join kelurahan inner join perusahaan_pasien inner join kecamatan inner join kabupaten inner join kamar_inap " +
                              ...
                              "and pasien.perusahaan_pasien=perusahaan_pasien.kode_perusahaan and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab and reg_periksa.no_rawat=kamar_inap.no_rawat "+
                              "where reg_periksa.no_rawat='"+TNoRw.getText()+"' ",param);
                this.setCursor(Cursor.getDefaultCursor());  
       }
    }//GEN-LAST:event_MnCetakSuratRawatActionPerformed

    private void MnCetakSuratCheckINActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratCheckINActionPerformed
        // TODO add your handling code here:
         if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("penyakit",Sequel.cariIsi("select concat(diagnosa_pasien.kd_penyakit,' ',penyakit.nm_penyakit) from diagnosa_pasien inner join reg_periksa inner join penyakit "+
                    ...
                    "where diagnosa_pasien.no_rawat=? and diagnosa_pasien.prioritas='1'",TNoRw.getText()));
                param.put("logo",Sequel.cariGambar("select logo from setting")); 
                Valid.MyReportqry("rptSKDCheckIN.jasper","report","::[ Surat Keterangan Rawat Inap ]::",
                              "select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y')as tgl_registrasi,perusahaan_pasien.nama_perusahaan,reg_periksa.no_rawat,dokter.nm_dokter,pasien.keluarga,pasien.namakeluarga,pasien.tgl_lahir,pasien.jk," +
                              " pasien.tmp_lahir,pasien.no_rkm_medis,pasien.agama,kamar_inap.diagnosa_awal,kamar_inap.diagnosa_akhir,pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.pekerjaan,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat" +
                              " from reg_periksa inner join pasien inner join dokter inner join kelurahan inner join perusahaan_pasien inner join kecamatan inner join kabupaten inner join kamar_inap " +
                              " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kel=kelurahan.kd_kel "+
    ...
    }//GEN-LAST:event_MnCetakSuratCheckINActionPerformed

    private void MnCetakSuratCheckOUTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratCheckOUTActionPerformed
        // TODO add your handling code here:
         if(TPasien.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu pasien...!!!");
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("penyakit",Sequel.cariIsi("select concat(diagnosa_pasien.kd_penyakit,' ',penyakit.nm_penyakit) from diagnosa_pasien inner join reg_periksa inner join penyakit "+
                    ...
                    "where diagnosa_pasien.no_rawat=? and diagnosa_pasien.prioritas='1'",TNoRw.getText()));
                param.put("logo",Sequel.cariGambar("select logo from setting")); 
                Valid.MyReportqry("rptSKDCheckOut.jasper","report","::[ Surat Keterangan Rawat Inap ]::",
                              "select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y')as tgl_registrasi,perusahaan_pasien.nama_perusahaan,reg_periksa.no_rawat,dokter.nm_dokter,pasien.keluarga,pasien.namakeluarga,pasien.tgl_lahir,pasien.jk," +
                              " pasien.tmp_lahir,pasien.no_rkm_medis,pasien.agama,DATE_FORMAT(kamar_inap.tgl_keluar,'%d-%m-%Y') as tgl_keluar,kamar_inap.diagnosa_awal,pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.pekerjaan,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat" +
                              " from reg_periksa inner join pasien inner join dokter inner join kelurahan inner join perusahaan_pasien inner join kecamatan inner join kabupaten inner join kamar_inap " +
                              " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kel=kelurahan.kd_kel "+
                              "and pasien.perusahaan_pasien=perusahaan_pasien.kode_perusahaan and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab and reg_periksa.no_rawat=kamar_inap.no_rawat "+
                              "where reg_periksa.no_rawat='"+TNoRw.getText()+"' ",param);
    ...
    }//GEN-LAST:event_MnCetakSuratCheckOUTActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakSuratCheckIN;
    private javax.swing.JMenuItem MnCetakSuratCheckOUT;
        ...
        try{
            ...
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                     "select surat_keterangan_rawat_inap.no_surat,surat_keterangan_rawat_inap.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                     "surat_keterangan_rawat_inap.tanggalawal,surat_keterangan_rawat_inap.tanggalakhir,surat_keterangan_rawat_inap.lamasakit "+                  
                     "from surat_keterangan_rawat_inap inner join reg_periksa on surat_keterangan_rawat_inap.no_rawat=reg_periksa.no_rawat "+
                     "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
    ...
    public void emptTeks() {
        ...
        // edit sesuai kebutuhan rs holistic 
      ...
      //          "SKD/RSH/"+TanggalAwal.getSelectedItem().toString().substring(3,5)+"/"+TanggalAwal.getSelectedItem().toString().substring(6,10)+"/",3,NoSurat); 
        ...
        // menambahkan format surat akan reset per tahun untuk rs holistic
        String NoUrut = Valid.autoNomer3("select ifnull(MAX(CONVERT(LEFT(no_surat,3),signed)),0) from surat_keterangan_rawat_inap where DATE_FORMAT(tanggalawal,'%Y')='"+TanggalAwal.getSelectedItem().toString().substring(6,10)+"' ",
                "",3);
        NoSurat.setText(NoUrut+"/SKD/RSH/"+ bln_romawi +"/"+TanggalAwal.getSelectedItem().toString().substring(6,10));
