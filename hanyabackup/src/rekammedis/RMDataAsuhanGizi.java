...
public final class RMDataAsuhanGizi extends javax.swing.JDialog {
    ...
    private String rp_merokok, rp_alkohol, rp_menyusui, rp_hamil, rp_kanker, rp_liver,
            rp_ht, sttsumur = "";
    ...
    public RMDataAsuhanGizi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode = new DefaultTableModel(null, new Object[] {
                "No.Rawat", "No.RM", "Nama Pasien", "J.K.", "Tgl.Lahir", "Tgl.Asuhan", "BB(Kg)", "TB(Cm)", "IMT(Kg/Cm)",
                "LiLA(Cm)", "TL(Cm)",
                "ULNA(Cm)", "BB Ideal(Kg)", "BB/U(%)", "TB/U(%)", "BB/TB(%)", "LiLA/U(%)", "Biokimia", "Fisik/Klinis",
                "Alergi Makanan", "Pantangan Makanan", "Makanan Kesukaan", "Makanan Tidak Disukai", "Nutrisi Terdahulu",
                "Nutrisi Sekarang",
                "Merokok", "Alkohol", "Menyusui", "Hamil", "Kanker", "Liver", "HT", "Pola Makan", "Riwayat Personal",
                "Diagnosis Gizi",
                "Intervensi Gizi",
        ...
        AlergiMakanan.setDocument(new batasInput((int) 1000).getKata(AlergiMakanan));
        PantanganMakanan.setDocument(new batasInput((int) 225).getKata(PantanganMakanan));
        MakananKesukaan.setDocument(new batasInput((int) 225).getKata(MakananKesukaan));
        MakananTidakDisukai.setDocument(new batasInput((int) 225).getKata(MakananTidakDisukai));
        NutrisiTerdahulu.setDocument(new batasInput((int) 225).getKata(NutrisiTerdahulu));
        NutrisiSekarang.setDocument(new batasInput((int) 225).getKata(NutrisiSekarang));
        RiwayatPersonal.setDocument(new batasInput((int) 1000).getKata(RiwayatPersonal));
        PolaMakan.setDocument(new batasInput((int) 1000).getKata(PolaMakan));
    ...
    private void initComponents() {
        ...
        MerokokYa = new widget.RadioButton();
        MerokokTidak = new widget.RadioButton();
        AlkoholTidak = new widget.RadioButton();
        AlkoholYa = new widget.RadioButton();
        jLabel45 = new widget.Label();
        jLabel46 = new widget.Label();
        MenyusuiYa = new widget.RadioButton();
        MenyusuiTidak = new widget.RadioButton();
        jLabel47 = new widget.Label();
        HamilYa = new widget.RadioButton();
        HamilTidak = new widget.RadioButton();
        jLabel48 = new widget.Label();
        KankerYa = new widget.RadioButton();
        KankerTidak = new widget.RadioButton();
        jLabel49 = new widget.Label();
        LiverYa = new widget.RadioButton();
        LiverTidak = new widget.RadioButton();
        HTYa = new widget.RadioButton();
        HTTidak = new widget.RadioButton();
        ...
        PantanganMakanan = new widget.TextBox();
        jLabel52 = new widget.Label();
        MakananKesukaan = new widget.TextBox();
        jLabel53 = new widget.Label();
        MakananTidakDisukai = new widget.TextBox();
        jLabel54 = new widget.Label();
        NutrisiTerdahulu = new widget.TextBox();
        jLabel55 = new widget.Label();
        NutrisiSekarang = new widget.TextBox();
        ...
        FormInput.setMaximumSize(new java.awt.Dimension(32767, 42767));
        ...
        label14.setBounds(0, 940, 130, 23);
        ...
        KdPetugas.setBounds(130, 940, 130, 23);

        NmPetugas.setEditable(false);
        NmPetugas.setName("NmPetugas"); // NOI18N
        NmPetugas.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(NmPetugas);
        NmPetugas.setBounds(260, 940, 300, 23);
        ...
        BtnDokter.setBounds(560, 940, 28, 23);
        ...
        jLabel9.setBounds(10, 250, 130, 23);
        ...
        jLabel37.setBounds(0, 180, 130, 23);
        ...
        PolaMakan.setBounds(170, 520, 610, 23);

        jLabel38.setText("Riwayat Konseling Gizi :");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(30, 650, 130, 23);

        jLabel40.setText("Diagnosis Gizi :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 730, 130, 23);

        jLabel41.setText("Intervensi Gizi :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(0, 800, 130, 23);

        jLabel42.setText("Monitoring & Evaluasi :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 870, 130, 23);

        jLabel39.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel39.setText("Merokok");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(180, 560, 170, 23);
        ...
        jLabel44.setBounds(0, 520, 160, 23);

        buttonGroup1.add(MerokokYa);
        MerokokYa.setText("Ya");
        MerokokYa.setName("MerokokYa"); // NOI18N
        MerokokYa.setPreferredSize(new java.awt.Dimension(40, 20));
        FormInput.add(MerokokYa);
        MerokokYa.setBounds(350, 560, 45, 23);

        buttonGroup1.add(MerokokTidak);
        MerokokTidak.setSelected(true);
        MerokokTidak.setText("Tidak");
        MerokokTidak.setName("MerokokTidak"); // NOI18N
        FormInput.add(MerokokTidak);
        MerokokTidak.setBounds(400, 560, 60, 23);

        buttonGroup2.add(AlkoholTidak);
        ...
        AlkoholTidak.setBounds(400, 580, 60, 23);

        buttonGroup2.add(AlkoholYa);
        AlkoholYa.setText("Ya");
        AlkoholYa.setName("AlkoholYa"); // NOI18N
        AlkoholYa.setPreferredSize(new java.awt.Dimension(40, 20));
        FormInput.add(AlkoholYa);
        AlkoholYa.setBounds(350, 580, 45, 23);

        jLabel45.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel45.setText("Alkohol");
        jLabel45.setName("jLabel45"); // NOI18N
        FormInput.add(jLabel45);
        jLabel45.setBounds(180, 580, 170, 23);

        jLabel46.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel46.setText("Menyusui");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(180, 600, 170, 23);

        buttonGroup3.add(MenyusuiYa);
        MenyusuiYa.setText("Ya");
        MenyusuiYa.setName("MenyusuiYa"); // NOI18N
        MenyusuiYa.setPreferredSize(new java.awt.Dimension(40, 20));
        FormInput.add(MenyusuiYa);
        MenyusuiYa.setBounds(350, 600, 45, 23);

        buttonGroup3.add(MenyusuiTidak);
        MenyusuiTidak.setSelected(true);
        MenyusuiTidak.setText("Tidak");
        MenyusuiTidak.setName("MenyusuiTidak"); // NOI18N
        FormInput.add(MenyusuiTidak);
        MenyusuiTidak.setBounds(400, 600, 60, 23);

        jLabel47.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel47.setText("Hamil");
        jLabel47.setName("jLabel47"); // NOI18N
        FormInput.add(jLabel47);
        jLabel47.setBounds(180, 620, 170, 23);

        buttonGroup4.add(HamilYa);
        HamilYa.setText("Ya");
        HamilYa.setName("HamilYa"); // NOI18N
        HamilYa.setPreferredSize(new java.awt.Dimension(40, 20));
        FormInput.add(HamilYa);
        HamilYa.setBounds(350, 620, 45, 23);

        buttonGroup4.add(HamilTidak);
        HamilTidak.setSelected(true);
        HamilTidak.setText("Tidak");
        HamilTidak.setName("HamilTidak"); // NOI18N
        FormInput.add(HamilTidak);
        HamilTidak.setBounds(400, 620, 60, 23);

        jLabel48.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel48.setText("Kanker");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(560, 560, 100, 23);

        buttonGroup5.add(KankerYa);
        KankerYa.setText("Ya");
        KankerYa.setName("KankerYa"); // NOI18N
        KankerYa.setPreferredSize(new java.awt.Dimension(40, 20));
        FormInput.add(KankerYa);
        KankerYa.setBounds(660, 560, 45, 23);

        buttonGroup5.add(KankerTidak);
        KankerTidak.setSelected(true);
        KankerTidak.setText("Tidak");
        KankerTidak.setName("KankerTidak"); // NOI18N
        FormInput.add(KankerTidak);
        KankerTidak.setBounds(710, 560, 60, 23);

        jLabel49.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel49.setText("Liver");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(560, 580, 100, 23);

        buttonGroup6.add(LiverYa);
        LiverYa.setText("Ya");
        LiverYa.setName("LiverYa"); // NOI18N
        LiverYa.setPreferredSize(new java.awt.Dimension(40, 20));
        FormInput.add(LiverYa);
        LiverYa.setBounds(660, 580, 45, 23);

        buttonGroup6.add(LiverTidak);
        LiverTidak.setSelected(true);
        LiverTidak.setText("Tidak");
        LiverTidak.setName("LiverTidak"); // NOI18N
        FormInput.add(LiverTidak);
        LiverTidak.setBounds(710, 580, 60, 23);

        buttonGroup7.add(HTYa);
        HTYa.setText("Ya");
        HTYa.setName("HTYa"); // NOI18N
        HTYa.setPreferredSize(new java.awt.Dimension(40, 20));
        FormInput.add(HTYa);
        HTYa.setBounds(660, 600, 45, 23);

        buttonGroup7.add(HTTidak);
        HTTidak.setSelected(true);
        HTTidak.setText("Tidak");
        HTTidak.setName("HTTidak"); // NOI18N
        FormInput.add(HTTidak);
        HTTidak.setBounds(710, 600, 60, 23);

        jLabel51.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel51.setText("HT");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(560, 600, 100, 23);
        ...
        RiwayatPersonal.setBounds(170, 650, 610, 23);
        ...
        scrollPane1.setBounds(140, 180, 645, 63);
        ...
        scrollPane2.setBounds(140, 250, 645, 63);
        ...
        scrollPane3.setBounds(140, 870, 645, 63);
        ...
        scrollPane4.setBounds(140, 800, 645, 63);
        ...
        scrollPane5.setBounds(140, 730, 645, 63);
        ...
        AlergiMakanan.setBounds(170, 340, 610, 23);

        PantanganMakanan.setFocusTraversalPolicyProvider(true);
        PantanganMakanan.setName("PantanganMakanan"); // NOI18N
        PantanganMakanan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PantanganMakananKeyPressed(evt);
            }
        });
        FormInput.add(PantanganMakanan);
        PantanganMakanan.setBounds(170, 370, 610, 23);

        jLabel52.setText("Pantangan Makanan :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(0, 370, 160, 23);

        MakananKesukaan.setFocusTraversalPolicyProvider(true);
        MakananKesukaan.setName("MakananKesukaan"); // NOI18N
        MakananKesukaan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                MakananKesukaanKeyPressed(evt);
            }
        });
        FormInput.add(MakananKesukaan);
        MakananKesukaan.setBounds(170, 400, 610, 23);

        jLabel53.setText("Makanan/Rasa Kesukaan :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(0, 400, 160, 23);

        MakananTidakDisukai.setFocusTraversalPolicyProvider(true);
        MakananTidakDisukai.setName("MakananTidakDisukai"); // NOI18N
        MakananTidakDisukai.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                MakananTidakDisukaiKeyPressed(evt);
            }
        });
        FormInput.add(MakananTidakDisukai);
        MakananTidakDisukai.setBounds(170, 430, 610, 23);

        jLabel54.setText("Makanan/Rasa Tidak disukai :");
        jLabel54.setName("jLabel54"); // NOI18N
        FormInput.add(jLabel54);
        jLabel54.setBounds(0, 430, 160, 23);

        NutrisiTerdahulu.setFocusTraversalPolicyProvider(true);
        NutrisiTerdahulu.setName("NutrisiTerdahulu"); // NOI18N
        NutrisiTerdahulu.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NutrisiTerdahuluKeyPressed(evt);
            }
        });
        FormInput.add(NutrisiTerdahulu);
        NutrisiTerdahulu.setBounds(170, 460, 610, 23);

        jLabel55.setText("Riwayat Nutrisi Dahulu :");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(0, 460, 160, 23);

        NutrisiSekarang.setFocusTraversalPolicyProvider(true);
        NutrisiSekarang.setName("NutrisiSekarang"); // NOI18N
        NutrisiSekarang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                NutrisiSekarangKeyPressed(evt);
            }
        });
        FormInput.add(NutrisiSekarang);
        NutrisiSekarang.setBounds(170, 490, 610, 23);

        jLabel56.setText("Riwayat Nutrisi Sekarang :");
        jLabel56.setName("jLabel56"); // NOI18N
        FormInput.add(jLabel56);
        jLabel56.setBounds(0, 490, 160, 23);

        jLabel57.setText("Riwayat Personal :");
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(0, 560, 130, 23);
    ...
    private void PantanganMakananKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_PantanganMakananKeyPressed
        // TODO add your handling code here:
    }// GEN-LAST:event_PantanganMakananKeyPressed

    private void MakananKesukaanKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_MakananKesukaanKeyPressed
        // TODO add your handling code here:
    }// GEN-LAST:event_MakananKesukaanKeyPressed

    private void MakananTidakDisukaiKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_MakananTidakDisukaiKeyPressed
        // TODO add your handling code here:
    }// GEN-LAST:event_MakananTidakDisukaiKeyPressed

    private void NutrisiTerdahuluKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_NutrisiTerdahuluKeyPressed
        // TODO add your handling code here:
    }// GEN-LAST:event_NutrisiTerdahuluKeyPressed

    private void NutrisiSekarangKeyPressed(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_NutrisiSekarangKeyPressed
        // TODO add your handling code here:
    }// GEN-LAST:event_NutrisiSekarangKeyPressed
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("")) {
        ...
        } else if (AlergiMakanan.getText().trim().equals("")) {
            Valid.textKosong(AlergiMakanan, "Alergi Makanan");
        } else if (PantanganMakanan.getText().trim().equals("")) {
            Valid.textKosong(PantanganMakanan, "Pantangan Makanan");
        } else if (MakananKesukaan.getText().trim().equals("")) {
            Valid.textKosong(MakananKesukaan, "Makanan Kesukaan");
        } else if (MakananTidakDisukai.getText().trim().equals("")) {
            Valid.textKosong(MakananTidakDisukai, "Makanan Tidak Disukai");
        } else if (NutrisiTerdahulu.getText().trim().equals("")) {
            Valid.textKosong(NutrisiTerdahulu, "Nutrisi Sebelumnya");
        } else if (NutrisiSekarang.getText().trim().equals("")) {
            Valid.textKosong(NutrisiSekarang, "Nutrisi Sekarang");
            ...
            rp_liver = "Tidak";
            rp_ht = "Tidak";
            if (MerokokYa.isSelected() == true) {
                rp_merokok = "Ya";
            }
            if (AlkoholYa.isSelected() == true) {
                rp_alkohol = "Ya";
            }
            if (MenyusuiYa.isSelected() == true) {
                rp_menyusui = "Ya";
            }
            if (MerokokYa.isSelected() == true) {
                rp_merokok = "Ya";
            }
            if (HamilYa.isSelected() == true) {
                rp_hamil = "Ya";
            }
            if (KankerYa.isSelected() == true) {
                rp_kanker = "Ya";
            }
            if (LiverYa.isSelected() == true) {
                rp_liver = "Ya";
            }
            if (HTYa.isSelected() == true) {
                rp_ht = "Ya";
            }
            ...
            if (Sequel.menyimpantf("asuhan_gizi", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                    "No.Rawat",
                    34, new String[] {
                            TNoRw.getText(), Valid.SetTgl(TglAsuhan.getSelectedItem() + ""), BB.getText(), TB.getText(),
                            IMT.getText(), LiLA.getText(),
                            TL.getText(), ULNA.getText(), BBIdeal.getText(), BBPerU.getText(), TBPerU.getText(),
                            BBPerTB.getText(), LiLAPerU.getText(),
                            Biokimia.getText(), FisikKlinis.getText(), AlergiMakanan.getText(),
                            PantanganMakanan.getText(), MakananKesukaan.getText(), MakananTidakDisukai.getText(),
                            NutrisiTerdahulu.getText(), NutrisiSekarang.getText(),
                            rp_merokok, rp_alkohol, rp_menyusui,
                            rp_hamil, rp_kanker,
                            rp_liver, rp_ht, PolaMakan.getText(), RiwayatPersonal.getText(),
                            DiagnosisGizi.getText(), IntervensiGizi.getText(),
                            Monitoring.getText(), KdPetugas.getText()
                    }) == true) {
                tabMode.addRow(new String[] {
                        TNoRw.getText(), TNoRM.getText(), TPasien.getText(), Jk.getText().substring(0, 1),
                        TglLahir.getText(), Valid.SetTgl(TglAsuhan.getSelectedItem() + ""),
                        BB.getText(), TB.getText(), IMT.getText(), LiLA.getText(), TL.getText(), ULNA.getText(),
                        BBIdeal.getText(), BBPerU.getText(), TBPerU.getText(), BBPerTB.getText(), LiLAPerU.getText(),
                        Biokimia.getText(), FisikKlinis.getText(), AlergiMakanan.getText(), PantanganMakanan.getText(),
                        MakananKesukaan.getText(), MakananTidakDisukai.getText(), NutrisiTerdahulu.getText(),
                        NutrisiSekarang.getText(),
                        rp_merokok, rp_alkohol,
                        rp_menyusui, rp_hamil, rp_kanker,
                        rp_liver, rp_ht, PolaMakan.getText(), RiwayatPersonal.getText(),
                        DiagnosisGizi.getText(), IntervensiGizi.getText(), Monitoring.getText(),
            ...
            if (TCari.getText().equals("")) {
                Valid.MyReportqry("rptDataAsuhanGiziPasien.jasper", "report", "::[ Data Asuhan Gizi Pasien ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asuhan_gizi.tanggal,"
                                ...
                                +
                                "asuhan_gizi.fisik_klinis,asuhan_gizi.alergi_makanan,asuhan_gizi.pantangan_makanan,asuhan_gizi.makanan_disukai,asuhan_gizi.makanan_tidak_disukai,asuhan_gizi.nutrisi_terdahulu,asuhan_gizi.nutrisi_sekarang,asuhan_gizi.rp_merokok,asuhan_gizi.rp_alkohol,asuhan_gizi.rp_menyusui,asuhan_gizi.rp_hamil,"
                                +
                                "asuhan_gizi.rp_kanker,asuhan_gizi.rp_liver,asuhan_gizi.rp_ht,asuhan_gizi.pola_makan,asuhan_gizi.riwayat_personal,"
                                +
                                ...
                                "asuhan_gizi.tanggal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
                                + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "")
                                + "' order by asuhan_gizi.tanggal",
                        param);
            } else {
                Valid.MyReportqry("rptDataAsuhanGiziPasien.jasper", "report", "::[ Data Asuhan Gizi Pasien ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asuhan_gizi.tanggal,"
                                ...
                                "asuhan_gizi.tanggal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
                                + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "")
                                + "' and pasien.no_rkm_medis like '%" + TCari.getText().trim() + "%' or " +
                                "asuhan_gizi.tanggal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
                                + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "")
                                + "' and pasien.nm_pasien like '%" + TCari.getText().trim() + "%' or " +
                                "asuhan_gizi.tanggal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
                                + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "")
                                + "' and asuhan_gizi.nip like '%" + TCari.getText().trim() + "%' or " +
                                "asuhan_gizi.tanggal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
                                + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "")
                                + "' and asuhan_gizi.diagnosis like '%" + TCari.getText().trim() + "%' or " +
                                "asuhan_gizi.tanggal between '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "")
                                + "' and '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "")
                                + "' and petugas.nama like '%" + TCari.getText().trim()
                                + "%' order by asuhan_gizi.tanggal",
                        param);
            }
        }
        ...
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptCetakAsuhanGizi.jasper", "report", "::[ Laporan Asuhan Gizi Pasien ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,asuhan_gizi.tanggal,"
                            ...
                            "inner join petugas on asuhan_gizi.nip=petugas.nip where asuhan_gizi.no_rawat='"
    ...
    private widget.RadioButton HTTidak;
    private widget.RadioButton HTYa;
    private widget.RadioButton HamilTidak;
    private widget.RadioButton HamilYa;
    private widget.TextBox IMT;
    private widget.TextArea IntervensiGizi;
    private widget.TextBox Jk;
    private widget.RadioButton KankerTidak;
    private widget.RadioButton KankerYa;
    private widget.TextBox KdPetugas;
    private widget.Label LCount;
    private widget.TextBox LiLA;
    private widget.TextBox LiLAPerU;
    private widget.RadioButton LiverTidak;
    private widget.RadioButton LiverYa;
    private widget.TextBox MakananKesukaan;
    private widget.TextBox MakananTidakDisukai;
    private widget.RadioButton MenyusuiTidak;
    private widget.RadioButton MenyusuiYa;
    private widget.RadioButton MerokokTidak;
    private widget.RadioButton MerokokYa;
    private javax.swing.JMenuItem MnAsuhanGizi;
    private widget.TextArea Monitoring;
    private widget.TextBox NmPetugas;
    private widget.TextBox NutrisiSekarang;
    private widget.TextBox NutrisiTerdahulu;
    private javax.swing.JPanel PanelInput;
    private widget.TextBox PantanganMakanan;
    ...
    public void tampil() {
        ...
        try {
             ...
             * "Biokimia","Fisik/Klinis","Alergi Makanan","Telur","Susu Sapi",
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new String[] {
                            ...
                            rs.getString("antropometri_imt"),
                            rs.getString("antropometri_lla"), rs.getString("antropometri_tl"),
                            rs.getString("antropometri_ulna"), rs.getString("antropometri_bbideal"),
                            rs.getString("antropometri_bbperu"), rs.getString("antropometri_tbperu"),
                            rs.getString("antropometri_bbpertb"), rs.getString("antropometri_llaperu"),
                            rs.getString("biokimia"), rs.getString("fisik_klinis"), rs.getString("alergi_makanan"),
                            rs.getString("pantangan_makanan"), rs.getString("makanan_disukai"),
                            rs.getString("makanan_tidak_disukai"), rs.getString("nutrisi_terdahulu"),
                            rs.getString("nutrisi_sekarang"), rs.getString("rp_merokok"),
                            rs.getString("rp_alkohol"),
                            rs.getString("rp_menyusui"), rs.getString("rp_hamil"), rs.getString("rp_kanker"),
                            rs.getString("rp_liver"),
                            rs.getString("rp_ht"), rs.getString("pola_makan"),
    ...
    public void emptTeks() {
        ...
        PantanganMakanan.setText("");
        MakananKesukaan.setText("");
        MakananTidakDisukai.setText("");
        NutrisiTerdahulu.setText("");
        NutrisiSekarang.setText("");
    ...
    private void getData() {
        if (tbObat.getSelectedRow() != -1) {
            ...
            AlergiMakanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 19).toString());
            PantanganMakanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 20).toString());
            MakananKesukaan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 21).toString());
            MakananTidakDisukai.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 22).toString());
            NutrisiTerdahulu.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 23).toString());
            NutrisiSekarang.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 24).toString());
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 25).toString().equals("Ya")) {
                MerokokYa.setSelected(true);
            } else {
                MerokokTidak.setSelected(true);
            }
            ...
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 27).toString().equals("Ya")) {
                MenyusuiYa.setSelected(true);
            } else {
                MenyusuiTidak.setSelected(true);
            }
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 28).toString().equals("Ya")) {
                HamilYa.setSelected(true);
            } else {
                HamilTidak.setSelected(true);
            }
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 29).toString().equals("Ya")) {
                KankerYa.setSelected(true);
            } else {
                KankerTidak.setSelected(true);
            }
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 30).toString().equals("Ya")) {
                LiverYa.setSelected(true);
            } else {
                LiverTidak.setSelected(true);
            }
            if (tbObat.getValueAt(tbObat.getSelectedRow(), 31).toString().equals("Ya")) {
                HTYa.setSelected(true);
            } else {
                HTTidak.setSelected(true);
            }
            PolaMakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 32).toString());
            RiwayatPersonal.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 33).toString());
            DiagnosisGizi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 34).toString());
            IntervensiGizi.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 35).toString());
            Monitoring.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 36).toString());
    ...
    private void isRawat() {
        ...
        Sequel.cariIsi(
                ...
                DiagnosaMasukRanap, TNoRw.getText());
    }
                ...
                IMT.setText(
                        Valid.SetAngka8(
                                Valid.SetAngka(BB.getText())
                                        / ((Valid.SetAngka(TB.getText()) / 100) * (Valid.SetAngka(TB.getText()) / 100)),
                                1) + "");
            } catch (Exception e) {
                IMT.setText("");
            }
    ...
    private void ganti() {
        ...
        if (Sequel.mengedittf("asuhan_gizi", "no_rawat=? and tanggal=?",
                "no_rawat=?,tanggal=?,antropometri_bb=?,antropometri_tb=?,antropometri_imt=?,antropometri_lla=?,antropometri_tl=?,antropometri_ulna=?,antropometri_bbideal=?,antropometri_bbperu=?,antropometri_tbperu=?,antropometri_bbpertb=?,antropometri_llaperu=?,biokimia=?,fisik_klinis=?,alergi_makanan=?,pantangan_makanan=?,makanan_disukai=?,makanan_tidak_disukai=?,nutrisi_terdahulu=?,nutrisi_sekarang=?,rp_merokok=?,rp_alkohol=?,rp_menyusui=?,rp_hamil=?,rp_kanker=?,rp_liver=?,rp_ht=?,pola_makan=?,riwayat_personal=?,diagnosis=?,intervensi_gizi=?,monitoring_evaluasi=?,nip=?",
                36, new String[] {
                        TNoRw.getText(), Valid.SetTgl(TglAsuhan.getSelectedItem() + ""), BB.getText(), TB.getText(),
                        IMT.getText(), LiLA.getText(),
                        TL.getText(), ULNA.getText(), BBIdeal.getText(), BBPerU.getText(), TBPerU.getText(),
            ...
            NutrisiTerdahulu.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 23).toString());
            NutrisiSekarang.setText(tbObat.getValueAt(tbObat.getSelectedRow(), 24).toString());
            tbObat.setValueAt(rp_merokok, tbObat.getSelectedRow(), 25);
            tbObat.setValueAt(rp_alkohol, tbObat.getSelectedRow(), 26);
            tbObat.setValueAt(rp_menyusui, tbObat.getSelectedRow(), 27);
            tbObat.setValueAt(rp_hamil, tbObat.getSelectedRow(), 28);
            tbObat.setValueAt(rp_kanker, tbObat.getSelectedRow(), 29);
            tbObat.setValueAt(rp_liver, tbObat.getSelectedRow(), 30);
            tbObat.setValueAt(rp_ht, tbObat.getSelectedRow(), 31);
            tbObat.setValueAt(PolaMakan.getText(), tbObat.getSelectedRow(), 32);
            tbObat.setValueAt(RiwayatPersonal.getText(), tbObat.getSelectedRow(), 33);
            tbObat.setValueAt(DiagnosisGizi.getText(), tbObat.getSelectedRow(), 34);
            tbObat.setValueAt(IntervensiGizi.getText(), tbObat.getSelectedRow(), 35);
            tbObat.setValueAt(Monitoring.getText(), tbObat.getSelectedRow(), 36);
            tbObat.setValueAt(KdPetugas.getText(), tbObat.getSelectedRow(), 37);
            tbObat.setValueAt(NmPetugas.getText(), tbObat.getSelectedRow(), 38);
            emptTeks();
        }
    }
