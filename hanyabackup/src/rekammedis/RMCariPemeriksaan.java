...
public final class RMCariPemeriksaan extends javax.swing.JDialog {
    ...
    public RMCariPemeriksaan(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"Tanggal","Jam","Pemeriksaan","Tanda Tanda Vital"};
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "concat('- Suhu: ',pemeriksaan_ralan.suhu_tubuh,'°C, TB: ',pemeriksaan_ralan.tinggi,'cm, Berat: ',pemeriksaan_ralan.berat,"+
                    "'kg, Tensi: ',pemeriksaan_ralan.tensi,', Respirasi: ',pemeriksaan_ralan.respirasi,', Nadi: ',pemeriksaan_ralan.nadi,"+
                    "', SpO2: ',pemeriksaan_ralan.spo2,', GCS: ',pemeriksaan_ralan.gcs) as ttv "+
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "concat('- Suhu: ',pemeriksaan_ranap.suhu_tubuh,'°C, TB: ',pemeriksaan_ranap.tinggi,'cm, Berat: ',pemeriksaan_ranap.berat,"+
                    "'kg, Tensi: ',pemeriksaan_ranap.tensi,', Respirasi: ',pemeriksaan_ranap.respirasi,', Nadi: ',pemeriksaan_ranap.nadi,"+
                    "', SpO2: ',pemeriksaan_ranap.spo2,', GCS: ',pemeriksaan_ranap.gcs) as ttv "+
