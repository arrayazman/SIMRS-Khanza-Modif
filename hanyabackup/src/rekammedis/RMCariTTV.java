...
public final class RMCariTTV extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Riwayat Pemeriksaan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.nadi " +
                            "from pemeriksaan_ralan where pemeriksaan_ralan.no_rawat=? and " +
                            "(pemeriksaan_ralan.tgl_perawatan like ? or pemeriksaan_ralan.nadi like ?) " +
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat,pemeriksaan_ranap.nadi " +
                            "from pemeriksaan_ranap where pemeriksaan_ranap.no_rawat=? and " +
                            "(pemeriksaan_ranap.tgl_perawatan like ? or pemeriksaan_ranap.nadi like ?) " +
